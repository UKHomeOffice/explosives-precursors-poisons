...
module.exports = {
  ...
  payment: {
    ...
    NEW_LICENCE_PAYMENT_DESCRIPTION: 'Payment for: New Explosives Precursors and Poisons Licence',
    RENEW_LICENCE_PAYMENT_DESCRIPTION: 'Payment for: Renew Explosives Precursors and Poisons Licence',
    REPLACE_LICENCE_PAYMENT_DESCRIPTION: 'Payment for: Replace Explosives Precursors and Poisons Licence',
    AMOUNT_NEW: 3950,
    AMOUNT_RENEW: 3950,
    AMOUNT_REPLACE: 2500,
